    ...
    public partial class Form1 : Form
    {
        ...
        private void MEandMC()
        {
            ...
            if (comboBoxSequence.SelectedIndex == 0)
            {
                ...
                strFileLoc = @"..\..\..\Resource\Foreman Sequences\CIF BMP\foreman_cif_";
            }
            else if (comboBoxSequence.SelectedIndex == 1)
            {
                strFileLoc = @"C:\Users\Chayut\Dropbox\Academic File 3.2\Intern (img)\Resource\Waterfall Sequence\waterfall_cif_";   
            }
            else
            {
                strFileLoc = @"C:\Users\Chayut\Dropbox\Academic File 3.2\Intern (img)\Resource\Stefan Sequence\stefan_cif_";          
            }
